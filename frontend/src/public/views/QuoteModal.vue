      ...
      <div class="quote-modal" @click.stop>
              ...
              <div class="booking-info">
                ...
                <div class="guests-selector">
                  ...
                  <div class="guests-controls">
                    <button type="button" @click="decreaseGuests" :disabled="selectedDates.guests <= 1"
                    ...
                    <button type="button" @click="increaseGuests" :disabled="selectedDates.guests >= 20"
                      class="btn-guest-control">
                      <AppIcon name="plus" />
                    </button>
                  </div>
          ...
          <div v-if="currentStep === 2" class="step-content">
            ...
            <div v-else class="mini-grid">
              <article v-for="activity in availableActivities" :key="activity.id" class="mini-card"
                ...
                <img class="mini-thumb" :src="activity.image" :alt="activity.name" loading="lazy" decoding="async" />
                <div class="mini-info">
          ...
          <div v-if="currentStep === 3" class="step-content">
            ...
            <div v-else class="mini-grid">
              <article v-for="menu in availableMenus" :key="menu.id" class="mini-card"
                :class="{ selected: selectedItems.menus.some(m => m.id === menu.id) }" @click="toggleMenu(menu)">
                <img class="mini-thumb" :src="menu.image" :alt="menu.name" loading="lazy" decoding="async" />
                <div class="mini-info">
          ...
          <div v-if="currentStep === 4" class="step-content">
            ...
            <div v-else class="mini-grid">
              <article v-for="room in availableRooms" :key="room.id" class="mini-card"
                ...
                <img class="mini-thumb" :src="room.image" :alt="room.name" loading="lazy" decoding="async" />
                <div class="mini-info">
                  <h5 class="mini-title">{{ room.name }}</h5>
                  <div class="mini-meta">
                    <span class="mini-price">{{ room.formatted_price }}/nuit</span>
                    <!-- SEULE INFO PRODUCTABLE : Capacité -->
                    <span v-if="room.productable_data?.capacity || room.productableData?.capacity" class="mini-pill">
                      <AppIcon name="users" />
          ...
          <div v-if="currentStep === 5" class="step-content">
            ...
            <div class="quote-summary">
              ...
              <div v-if="pricing.lines.some(l => l.type === 'activity')" class="summary-section">
                <h4>
                  <AppIcon name="footprints" /> Activités
                </h4>
              ...
              <div class="summary-section">
                <h4>
                  <AppIcon name="calendar" /> Détails du séjour
                </h4>
              ...
              <div class="summary-total">
                ...
                <p v-if="depositEnabled" class="deposit-note">
                  Le solde de {{ formatPrice(totalPrice - depositAmount) }} sera à régler ultérieurement.
                </p>
              </div>
            </div>
            ...
            <div class="contact-form">
              ...
              <div class="form-row">
                ...
                <input type="text" v-model="contactInfo.last_name" placeholder="Nom" class="form-input" />
              </div>
              <div class="form-row">
                <input type="email" v-model="contactInfo.email" placeholder="Email" class="form-input" />
        ...
        <div class="modal-footer">
          ...
          <div class="footer-right">
            <button v-if="currentStep < 5" @click="nextStep" class="btn btn-primary btn-sm" :disabled="!canProceed">
              Suivant
              <AppIcon name="arrow-right" />
            </button>
            ...
            <div v-else class="quote-final-step">
              ...
              <div class="quote-actions">
                ...
                <button @click="requestAdvice" class="btn btn-outline btn-sm" :disabled="isSubmitting || !canSubmit">
...
export default {
  ...
  computed: {
    ...
    depositEnabled() {
      return useInstanceStore().hasFeature('deposit_payment')
    },

    depositPercentage() {
      return useInstanceStore().features.deposit_percentage ?? 30
    },

    depositAmount() {
      return Math.round(this.totalPrice * this.depositPercentage / 100 * 100) / 100
    },
