...
class ActivityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     }
            ...
            // return redirect()->route('/')->with('success', 'Activité enregistrée dans les brouillons.');
        // }

        $activity->save();

        return redirect()->route('/')->with('success', 'Activité enregistrée avec succès.');
    }
    ...
    public function update(Request $request, Activity $activity)
    {
        ...
        $activity->save();
        return redirect()->route('/')->with('success', 'Activité mise à jour avec succès.');
    }
    ...
    public function destroy(Activity $activity)
    {
        ...
        $activity->delete();
        return redirect()->route('/')->with('success', 'Activité supprimée avec succès.');
    }
}
